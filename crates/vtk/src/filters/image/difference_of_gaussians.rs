...
pub fn image_dog(input: &ImageData, scalars: &str, sigma1: f64, sigma2: f64, radius: usize) -> ImageData {
    let g1=crate::filters::image::gaussian_smooth::image_gaussian_smooth(input,scalars,sigma1,radius);
    let g2=crate::filters::image::gaussian_smooth::image_gaussian_smooth(input,scalars,sigma2,radius);
