...
pub fn image_morphological_opening(input: &ImageData, scalars: &str, radius: usize) -> ImageData {
    let eroded = crate::dilate_erode::image_erode(input, scalars, radius);
    crate::dilate_erode::image_dilate(&eroded, scalars, radius)
}
...
pub fn image_morphological_closing(input: &ImageData, scalars: &str, radius: usize) -> ImageData {
    let dilated = crate::dilate_erode::image_dilate(input, scalars, radius);
    crate::dilate_erode::image_erode(&dilated, scalars, radius)
}
